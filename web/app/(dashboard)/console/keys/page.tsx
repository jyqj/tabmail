        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              emptyIcon={Key}
              emptyText={t("apiKeys.noKeys")}
              emptyHint={t("apiKeys.noKeysHint")}
              columns={[
                { key: "label", header: t("apiKeys.label") },
                { key: "prefix", header: t("apiKeys.prefix") },
                { key: "scopes", header: t("apiKeys.scopes") },
                { key: "allowedZones", header: t("apiKeys.allowedZones") },
                { key: "lastUsed", header: t("apiKeys.lastUsed") },
                { key: "created", header: t("apiKeys.created") },
